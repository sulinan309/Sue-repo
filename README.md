...
AI 攀岩搭子。五个长期工作单元协作推进，机制见 [project/README.md](project/README.md)。
...
| 目录 | 归谁写 | 内容 |
|---|---|---|
| `climbing-kb/` | research | 知识库、来源转录、评测案例 |
| `product/` | product | 产品大图、MVP 范围、PRD、验收标准 |
| `annotator/` | engineer | 感知管线与产物 |
| `qa/` | qa | 测试计划、回归基线、缺陷清单、测试报告 |
| `project/` | pm | 总表、看板、决策记录、风险清单、日报 |
